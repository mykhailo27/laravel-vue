    ...
    <nav
        ...
        <ul id="scroll-container"
            ...
            <li class="relative mt-3">
                <Link :href="route('dashboard')"
                      ...
                      data-te-ripple-init data-te-sidenav-link-ref data-te-ripple-color="primary">
                    <span
      ...
      >
        ...
        <span
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Font-icons, Inc. -->
            <path
      ...
      >
        ...
        <div class="absolute bottom-0 w-full bg-inherit text-center">
            ...
            <a class="flex cursor-pointer items-center truncate rounded-[5px] px-6 py-3 text-[0.85rem] text-gray-600 outline-none transition duration-300 ease-linear hover:bg-slate-50 hover:text-inherit hover:outline-none focus:bg-slate-50 focus:text-inherit focus:outline-none active:bg-slate-50 active:text-inherit active:outline-none data-[te-sidenav-state-active]:text-inherit data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10"
               data-te-sidenav-link-ref
